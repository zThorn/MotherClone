...
declare module Phaser {
    ...
    module Filter {
        ...
        class BinarySerpents extends Phaser.PFilter {
        ...
        class BlurX extends Phaser.PFilter {

            blur: number;

        }

        class BlurY extends Phaser.PFilter {

            blur: number;

        }

        class CausticLight extends Phaser.PFilter {
        ...
        class CheckerWave extends Phaser.PFilter {
        ...
        class ColorBars extends Phaser.PFilter {
        ...
        class Fire extends Phaser.PFilter {
        ...
        class Gray extends Phaser.PFilter {

            gray: number;

        }

        class HueRotate extends Phaser.PFilter {
        ...
        class LightBeam extends Phaser.PFilter {
        ...
        class Marble extends Phaser.PFilter {
        ...
        class Plasma extends Phaser.PFilter {
        ...
        class SampleFilter extends Phaser.PFilter {
        ...
        class Tunnel extends Phaser.PFilter {
    ...
    class PFilter implements PIXI.IAbstractFilter {
    ...
    class GameObjectCreator {
        ...
        filter(filter: any, ...args: any[]): Phaser.PFilter;
    ...
    class GameObjectFactory {
        ...
        filter(filter: string, ...args: any[]): Phaser.PFilter;
